...
compressed meta-block은 단일-tree literal/copy와 block switching 일부를
해제할 수 있으며, context mode/static dictionary 등 미지원 경로는 `-4`를
반환한다.
...
1. literal context mode와 context id 계산 반영
