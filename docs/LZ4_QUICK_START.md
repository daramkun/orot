...
cmake -DOROT_TESTS=ON -DOROT_BENCHMARK=ON -DCMAKE_BUILD_TYPE=Release ..
...
```bash
cmake -DOROT_TESTS=ON -DOROT_BENCHMARK_COMPARE=ON -DCMAKE_BUILD_TYPE=Release ..
